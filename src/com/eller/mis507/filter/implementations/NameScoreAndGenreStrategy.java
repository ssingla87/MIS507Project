...
public class NameScoreAndGenreStrategy implements FilterMovieStrategy {
	...
	public List<Movie> filter(FilterCriteria criteria, List<Movie> moviesList) {
		...
		CollectionUtils.filter(moviesList, new Predicate() {
			...
			public boolean evaluate(Object o) {
				return ((Movie) o).getName().equals(criteria.getName()) && ((Movie) o).getScore() >= criteria.getScore()
						&& ((Movie) o).getGenre() == criteria.getGenre();
			}
